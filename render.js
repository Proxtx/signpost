...
export class GridRenderer {
  ...
  canvasSetup() {
    this.gridWidth =
      this.grid.length * (this.cellSize + this.borderSize) + this.borderSize;
    this.gridHeight =
      this.grid[0].length * (this.cellSize + this.borderSize) + this.borderSize;
  ...
  render() {
    ...
    for (let indexRow in this.grid) {
      for (let indexColumn in this.grid[indexRow]) {
        this.renderSign(
          this.grid[indexRow][indexColumn],
          indexRow,
          indexColumn
        );
      }
  ...
  drawArrowOfSign(sign, x, y) {
    ...
    if (sign.arrowDirection)
      this.drawArrow(
        x + this.arrowSize * 1.3,
        y + this.arrowSize * 1.3,
        this.arrowDirectionTranslator[
          this.compileArrowDirection(...sign.arrowDirection)
        ]
      );
